...
\resizebox{\linewidth}{!}{
\begin{tikzpicture}[
    class/.style={rectangle, draw=black, thick, fill=white, text width=5cm, font=\scriptsize},
...
\node[abstract] (iMediator) {\textbf{\textit{IATCMediator}}\\\rule{5cm}{0.3pt}\\\textit{+ registerFlight(Flight): void}\\\textit{+ requestLanding(Flight*): bool}\\\textit{+ notifyRunwayClear(Flight*): void}\\\textit{+ broadcastEmergency(Flight*, str): void}};

\node[abstract, right=1.6cm of iMediator] (flightBase) {\textbf{\textit{Flight}}\\\rule{5cm}{0.3pt}\\- mediator\_: IATCMediator*\\- flightCode\_: string\\+ requestLanding(): bool\\+ land(): void\\+ receiveMessage(from, msg): void};

% Concrete Mediator: ATCTower (bottom-left)
\node[medclass, below=1.4cm of iMediator] (atcTower) {\textbf{ATCTower}\\\rule{5cm}{0.3pt}\\- runwayClear\_: bool\\- currentRunwayUser\_: Flight*\\- landingQueue\_: queue$<$Flight*$>$\\- activeFlights\_: vector$<$shared\_ptr$>$\\+ registerFlight(Flight): void\\+ requestLanding(Flight*): bool\\+ notifyRunwayClear(Flight*): void\\+ broadcastEmergency(Flight*, str): void};

% Concrete Colleagues (bottom-right column)
\node[colclass, below=1.2cm of flightBase] (commFlight) {\textbf{CommercialFlight}\\\rule{5cm}{0.3pt}\\- passengerCount\_: int\\+ requestLanding(): bool};

\node[colclass, below=0.5cm of commFlight] (cargoFlight) {\textbf{CargoFlight}\\\rule{5cm}{0.3pt}\\- cargoWeightTons\_: double\\+ requestLanding(): bool};

\node[colclass, below=0.5cm of cargoFlight] (emergFlight) {\textbf{EmergencyFlight}\\\rule{5cm}{0.3pt}\\+ declareEmergency(reason: str): void};
