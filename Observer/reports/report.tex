...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{pattern_console_output.png}
    \caption{Console Output of the Pattern-Based Bank Account Demo (Dynamic Observers)}
    \label{fig:pattern_console_output}
\end{figure}
